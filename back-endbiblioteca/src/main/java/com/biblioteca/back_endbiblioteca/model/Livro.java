...
public class Livro {
	...
	@Override
	public String toString() { return "Livro{" + "id=" + id + ", titulo='" + titulo + '\'' + ", autor='" + autor + '\'' + ", ano=" + ano + ", editora='" + editora + '\'' + ", classificacao='" + classificacao + '\'' + ", numeroPaginas=" + numeroPaginas + ", isbn='" + isbn + '\'' + ", observacao='" + observacao + '\'' + ", dataCadastro=" + dataCadastro + '}'; }
